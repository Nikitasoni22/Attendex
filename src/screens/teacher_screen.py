...
from src.database.db import teacher_logins,get_teacher_subject
...
def login_teacher(username,password):
    ...
    teacher = teacher_logins(username,password)
...
def teacher_register():
        ...
        with btcn1:
            if st.button('Login Instead',icon=':material/passkey:',shortcut="ctrl+enter",width='stretch'):
